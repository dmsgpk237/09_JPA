...
//        menuList.forEach(menu -> System.out.println(menu));
    ...
    @Test
    void testDirectInertSql() throws SQLException {

        // given
        Menu menu = new Menu();
        menu.setMenuName("손수타 짜장면");
    ...
    * menu.getCategory().getCategoryName(); // NPE(Null point exception)가 발생하지 않음.
    * */
