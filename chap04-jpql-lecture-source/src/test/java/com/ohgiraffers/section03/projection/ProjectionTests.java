    ...
    * */
    ...
    void test2() {
        ...
        BiDirectionCategory category =
                entityManager.createQuery(jpql, BiDirectionCategory.class).setParameter("menuCode", menuCodeParameter).getSingleResult();
    ...
    void test4() {
        ...
        // then
        assertNotNull(categoryNameList); // 내용이 있는지 없는지 확인하고
        categoryNameList.forEach(System.out::println); // 출력해주기
    ...
    void test5() {
        ...
        // then
        assertNotNull(categoryList); // 내용이 있는지 없는지 확인하고
