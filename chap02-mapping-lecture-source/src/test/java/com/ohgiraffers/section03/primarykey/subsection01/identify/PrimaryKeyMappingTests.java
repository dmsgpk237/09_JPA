...
public class PrimaryKeyMappingTests {
    ...
    * */
    ...
    public void identityMappingTest() {
        ...
        member1.setPhone("010-2456-7555");
        member1.setEmail("email01@gmail.com");
        member1.setAddress("서울시 강서구");
        ...
        member2.setNickname("도라에몽");
        member2.setPhone("010-2423-7555");
        member2.setEmail("email01@gmail.com");
        member2.setAddress("서울시 강서구");
        ...
        String jpql = "select a.memberNo from member_section03_sub01 a"; // entity 명 사용 별칭(여기서는 a) 필수
        List<Integer> members = entityManager.createQuery(jpql, Integer.class).getResultList();

//        members.forEach(System.out::println); 아래 for문이랑 같음
